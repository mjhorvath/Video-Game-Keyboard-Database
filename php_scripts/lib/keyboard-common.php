<?php
	...
	// defaults could be set within the database instead, though doing it here may be simpler
	$default_game_id	= 1;
	$default_style_id	= 15;
	$default_layout_id	= 1;
	$default_format_id	= 0;
	$default_svg_bool	= 0;
	$default_ten_bool	= 1;
	$default_game_seo	= "test-sample";	// this should be looked up in database instead of hardcoded
	$default_game_name	= "";	// this should be looked up in database instead of hardcoded
	$default_style_name	= "";	// this should be looked up in database instead of hardcoded
	$default_layout_name	= "";	// this should be looked up in database instead of hardcoded

	function checkURLParameters($code_format)
	{
		global $php_url, $svg_url, $game_seo, $game_id, $style_id, $layout_id, $format_id, $svg_bool, $ten_bool;
