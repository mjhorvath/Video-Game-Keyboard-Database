...
<p>I have also recently started developing a form-based submission page. You can use it to submit changes to existing bindings by selecting the "Editor" option in Step 4, above. Or, you can get started making a brand new set of bindings with the "Blank Starter" in the "Reference" category (there are blank starters for every keyboard and theme). I personally still prefer using the spreadsheet for this purpose, however.</p>
