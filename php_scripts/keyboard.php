...
<p>The source code for this project is licensed under the <a target="_blank" href="GNU General Public License">GPLv3</a>. The content is licensed under the <a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/">CC BY-SA 3.0</a>. Visit the <a href="https://github.com/mjhorvath/vgkd">GitHub repository</a> for the project's source code. The <a href="keyboard-log.php">change log</a> contains the project's update history and credits, as well as links to further reading. A "to do" list can be found <a href="to_do_list.txt">here</a>.</p>
<p>To submit a new set of bindings, you can fill out <a href="<?php echo $path_root; ?>files/binding_template_us104key.xlsx">this spreadsheet</a> and <a href="http://isometricland.net/email.php">email</a> me the contents (copy and paste) when you are done. Note that any content you submit falls under the <a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/">CC BY-SA 3.0</a> license, as per the project as a whole. Your name will then appear at the bottom of each chart, as well as in the change log.</p>
<p>I have also recently started developing a form-based submission page. You can use it to submit changes to existing bindings by selecting the "Editor" option in Step 4, above. Or, you can get started making a brand new set of bindings with this <a href="keyboard-diagram-blank-sample.php?sty=15&lay=1&fmt=3">blank sample</a>. I personally still prefer using the spreadsheet for this purpose, however.</p>
<p></p>
