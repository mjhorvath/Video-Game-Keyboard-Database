...
LOAD DATA LOCAL INFILE 'C:\\Users\\mikh2\\Website\\Keyboard\\helper_tools\\_bindings.txt' INTO TABLE isometr1_keyboard.bindings
CHARACTER SET 'utf8'
FIELDS TERMINATED BY '\t'
LINES TERMINATED BY '\r\n';

SET FOREIGN_KEY_CHECKS = 0;
LOAD DATA LOCAL INFILE 'C:\\Users\\mikh2\\Website\\Keyboard\\helper_tools\\_commands.txt' INTO TABLE isometr1_keyboard.commands
CHARACTER SET 'utf8'
FIELDS TERMINATED BY '\t'
LINES TERMINATED BY '\r\n';

SET FOREIGN_KEY_CHECKS = 0;
LOAD DATA LOCAL INFILE 'C:\\Users\\mikh2\\Website\\Keyboard\\helper_tools\\_legends.txt' INTO TABLE isometr1_keyboard.legends
CHARACTER SET 'utf8'
FIELDS TERMINATED BY '\t'
LINES TERMINATED BY '\r\n';
...
SET FOREIGN_KEY_CHECKS = 0;
LOAD DATA LOCAL INFILE 'C:\\Users\\mikh2\\Website\\Keyboard\\helper_tools\\_positions.txt' INTO TABLE isometr1_keyboard.positions
CHARACTER SET 'utf8'
FIELDS TERMINATED BY '\t'
LINES TERMINATED BY '\r\n';

SET FOREIGN_KEY_CHECKS = 0;
LOAD DATA LOCAL INFILE 'C:\\Users\\mikh2\\Website\\Keyboard\\helper_tools\\_records_styles.txt' INTO TABLE isometr1_keyboard.records_styles
CHARACTER SET 'utf8'
FIELDS TERMINATED BY '\t'
LINES TERMINATED BY '\r\n';
