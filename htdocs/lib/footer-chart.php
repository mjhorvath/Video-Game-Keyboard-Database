...
'<div class="boxdiv">
	...
	<p>&quot;Video Game Keyboard Database&quot; software was created by <a target="_blank" href="https://isometricland.net">Michael Horvath</a> and is licensed under <a target="_blank" rel="license" href="https://www.gnu.org/licenses/lgpl-3.0.en.html">GNU LGPLv3</a> or later. Content is licensed under <a target="_blank" href="https://creativecommons.org/licenses/by-sa/3.0/">CC BY-SA 3.0</a> or later. You can find this project on <a target="_blank" href="https://github.com/mjhorvath/vgkd">GitHub</a>.</p>
	<p>Return to <a href="' . $path_vgkd . 'keyboard.php">Video Game Keyboard Database</a>. View the <a href="' . $path_vgkd . 'keyboard-list.php">master table</a>, <a href="' . $path_vgkd . 'keyboard-credits.php">credits</a> or <a href="' . $path_vgkd . 'keyboard-log.php">change log</a>. Here is a <a href="' . $path_vgkd . 'keyboard-links.php">list of links</a>. Having trouble printing? Take a look at <a href="' . $path_vgkd . 'keyboard.php#print_tips">these printing tips</a>.</p>
';
...
'			<tr style="display:' . $display_format . ';">
			...
			<tr style="display:' . $display_keycap . ';">
				<th>Key labels:</th>
				<td>
					<input class="stylechange" type="radio" name="kcap" id="kcaprad0" value="0"' . ($kcap_flag == 0 ? ' checked' : '') . '/><label for="kcaprad0">Normal &#10022;</label>
