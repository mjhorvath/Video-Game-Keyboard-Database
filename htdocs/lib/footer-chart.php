...
"<div class=\"boxdiv\">
	...
	<p>Return to <a href=\"" . $path_vgkb . "keyboard.php\">Video Game Keyboard Diagrams</a>. View the <a href=\"" . $path_vgkb . "keyboard-list.php\">master table</a>, <a href=\"" . $path_vgkb . "keyboard-credits.php\">credits</a> or <a href=\"" . $path_vgkb . "keyboard-log.php\">change log</a>. Here is a <a href=\"" . $path_vgkb . "keyboard-links.php\">list of links</a>. Having trouble printing? Take a look at <a href=\"" . $path_vgkb . "keyboard.php#print_tips\">these printing tips</a>.</p>\n";
	// display toggles
...
"			<tr style=\"display:" . $display_format . ";\">
	...
	{
		echo
"	<p><input class=\"stylechange\" type=\"button\" value=\"Export This Diagram\" onclick=\"document_export_main_ajax();\" /></p>\n";
	}
	echo
"	<p>\n";
