...
?>
	<body onload="init_footer();">
		<header>
			<h2><?php echo cleantextHTML($page_title_a) ?><small><?php echo cleantextHTML($page_title_b); ?></small></h2>
			<p><?php echo cleantextHTML($language_title) . ': ' . cleantextHTML($language_description); ?></p>
		</header>
		<main>
