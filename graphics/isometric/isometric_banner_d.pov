...
camera
{
	...
	right		x * 1 * ScreenArea
	up		y * 4/1 * ScreenArea/AspectRatio
//	rotate		x * 90
		...
		intersection
		{
			#switch (Axes_Number)
				#case (3)
					text
					{
						ttf Font_Name String_Array[2][12-iCount] 1/2, 0
						rotate		+x * 090
						translate	-x * 1/2
						translate	+y * 1/2
						translate	-z * 1/2
				...
				#case (2)
					text
					{
						ttf Font_Name String_Array[1][12-iCount] 1/2, 0
						translate	-x * 1/2
						translate	-z * 1/2
					}
				#case (1)
					text
					{
						ttf Font_Name String_Array[0][12-iCount] 1/2, 0
						rotate		+y * 090
						translate	-x * 1/2
					}
				#break
