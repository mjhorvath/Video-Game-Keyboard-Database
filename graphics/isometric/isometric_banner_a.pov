...
union
{
	text
	{
		ttf "VeraMono.ttf" "I" 1/10, 0
		translate	-x/2
	}
	text
	{
		ttf "VeraMono.ttf" "S" 1/10, 0
		rotate		y * 090
	}
	text
	{
		ttf "VeraMono.ttf" "O" 1/10, 0
		translate	-x/2
		translate	+x/2 * 1
		translate	-z/2 * 1
	}
